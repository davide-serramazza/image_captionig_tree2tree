...
def train_model(FLAGS, decoder, encoder, train_data,val_data,
    ...
    with tfs.always_record_summaries():
        for i in range(FLAGS.max_iter):
            ...
            for j in range(0,len_input,batch_size):
                with tfe.GradientTape() as tape:
                    ...
                    if tree_decoder:
                        ...
                        # compute global loss
                        loss_struct_miniBatch, loss_values_miniBatch, mean_miniBatch = batch_dec.reconstruction_loss()
                        ...
                        mean_w +=mean_miniBatch["word"]
                        mean_p +=mean_miniBatch["POS_tag"]
                    else:
                        loss_single_word=0
            ...
            tfs.scalar("loss/mean_w", mean_w);
            tfs.scalar("loss/mean_p", mean_p);
            # print stats
            if i % FLAGS.check_every == 0:
                ...
                if tree_decoder:
                    ...
                    loss_struct_val, loss_values_validation ,mean= batch_val_dec.reconstruction_loss()
